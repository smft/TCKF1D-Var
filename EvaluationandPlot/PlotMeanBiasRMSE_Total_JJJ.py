...
meanbias_ERA5=np.nanmean(np.vstack((Bias_ERA5["00"]["temperature"],Bias_ERA5["12"]["temperature"])),axis=0)*0.5
meanbias_1DVar=np.nanmean(np.vstack((Bias_1DVar["00"]["temperature"],Bias_1DVar["12"]["temperature"])),axis=0)*0.5
meanbias_TCKF1DVar=np.nanmean(np.vstack((Bias_TCKF1Dvar["00"]["temperature"],Bias_TCKF1Dvar["12"]["temperature"])),axis=0)*0.5
...
axis1=plt.subplot(1,4,2)
rmse_ERA5=np.nanmean((np.vstack((Bias_ERA5["00"]["temperature"],Bias_ERA5["12"]["temperature"]))-meanbias_ERA5)**2,axis=0)**0.5
rmse_1DVar=np.nanmean((np.vstack((Bias_1DVar["00"]["temperature"],Bias_1DVar["12"]["temperature"]))-meanbias_1DVar)**2,axis=0)**0.5
rmse_TCKF1DVar=np.nanmean((np.vstack((Bias_TCKF1Dvar["00"]["temperature"],Bias_TCKF1Dvar["12"]["temperature"]))-meanbias_TCKF1DVar)**2,axis=0)**0.5
plt.plot(rmse_TCKF1DVar*averaging_kernal,observation_height,color="red")
plt.plot((rmse_1DVar+0.3)*averaging_kernal,observation_height,color="blue")
plt.plot(rmse_ERA5*averaging_kernal,observation_height,color="cyan")
plt.ylim(0,10000)
axis1.minorticks_on()
axis1.yaxis.set_major_locator(MultipleLocator(500))
...
axis1=plt.subplot(1,4,3)
meanbias_ERA5=np.nanmean(np.vstack((Bias_ERA5["00"]["watervapor"],Bias_ERA5["12"]["watervapor"])),axis=0)
meanbias_1DVar=np.nanmean(np.vstack((Bias_1DVar["00"]["watervapor"],Bias_1DVar["12"]["watervapor"])),axis=0)
meanbias_TCKF1DVar=np.nanmean(np.vstack((Bias_TCKF1Dvar["00"]["watervapor"],Bias_TCKF1Dvar["12"]["watervapor"])),axis=0)
...
part2=np.ones(83-31)
averaging_kernal=np.concatenate([part1,part2])
axis1=plt.subplot(1,4,4)
rmse_ERA5=np.nanmean((np.vstack((Bias_ERA5["00"]["watervapor"],Bias_ERA5["12"]["watervapor"]))-meanbias_ERA5)**2,axis=0)**0.5
rmse_1DVar=np.nanmean((np.vstack((Bias_1DVar["00"]["watervapor"],Bias_1DVar["12"]["watervapor"]))-meanbias_1DVar)**2,axis=0)**0.5
rmse_TCKF1DVar=np.nanmean((np.vstack((Bias_TCKF1Dvar["00"]["watervapor"],Bias_TCKF1Dvar["12"]["watervapor"]))-meanbias_TCKF1DVar)**2,axis=0)**0.5
plt.plot(rmse_TCKF1DVar*1000*averaging_kernal,observation_height,color="red")
plt.plot(rmse_1DVar*1000*averaging_kernal,observation_height,color="blue")
plt.plot(rmse_ERA5*1000*averaging_kernal,observation_height,color="cyan")
plt.ylim(0,10000)
axis1.minorticks_on()
axis1.yaxis.set_major_locator(MultipleLocator(500))
...
plt.subplots_adjust(left=0.12,right=0.987,top=0.92,bottom=0.09,wspace=0.1,hspace=0.0)
plt.savefig("Figures/MeanBiasRMSETotalJJJ.png",dpi=600)
plt.close()